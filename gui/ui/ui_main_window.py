...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.noteTreeContainer = QWidget(self.verticalSplitter)
        self.noteTreeContainer.setObjectName(u"noteTreeContainer")
        self.noteTreeContainer.setMinimumSize(QSize(0, 0))
        self.verticalSplitter.addWidget(self.noteTreeContainer)
